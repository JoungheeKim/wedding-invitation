            ...
            <div className="bg(--color-white) p(29px/28px)">
              ...
              <div className="vbox(fill) pack vgap(8px)">
                ...
                <div className="vbox(fill) pack vgap(5px)">
                  <h3 className={nameClass}>김 정희</h3>
                  <p>X</p>
                  <h3 className={nameClass}>도 유진</h3>
                </div>
              ...
              <div className="hbox(fill) space-between mt(20)">
                <div>
                  ...
                  <p className={text2}>12월 3일</p>
                </div>

                <div>
                  <p className={title2}>BOARDING 시간</p>
                  <p className={text2}>15 : 30</p>
                </div>
              </div>
              <div className="mt(20)">
                <p className={title2}>GATE 장소</p>
                <p className={text2}>AT 포레<br />그랜드홀 5층</p>
              </div>
            </div>
          </div>
          {/* >>> TOP TICKET >>> */}
            ...
            <div className="bg(--color-white)">
              <div className="hbox(fill)">
                <div className="vbox(fill) flex(1)">
                  ...
                  <p className="font-family(--font-ticket-2) bold font(14) p(8px/0/8px/14px) bb(1/solid/--color-gray-200)">03.DEC.2023</p>
